...
def convert_pi0_checkpoint(
    ...
    elif "pi0_libero" in checkpoint_dir:
        pi0_config = PI0Config(
            empty_cameras=0,
            adapt_to_pi_aloha=False,
            use_delta_joint_actions_aloha=False,
        )
    elif "pi0_fast_libero" in checkpoint_dir:
    ...
    print(paligemma_params.keys())
    pi0_model.load_state_dict({**paligemma_params})
    ...
    del pi0_model
    PI0FASTPolicy.from_pretrained(output_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--tokenizer_hub_id",
        default="/home/dzb/pretrained/paligemma3b",
        type=str,
